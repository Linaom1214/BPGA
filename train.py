...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.dataset == 'sirstaug':
            ...
            train_img_ids, val_img_ids, test_txt = load_dataset("data", "NUDT-SIRST", "idx_4961+847")
            # Preprocess and load data
            input_transform = transforms.Compose([
                transforms.ToTensor()])
            trainset   = TrainSetLoader(dataset_dir='./data/NUDT-SIRST',img_id=train_img_ids,base_size=args.base_size,transform=input_transform)
            valset     = TestSetLoader (dataset_dir='./data/NUDT-SIRST',img_id=val_img_ids,base_size=args.base_size, transform=input_transform)
    ...
    def training(self, epoch):
        ...
        for i, (data, labels) in enumerate(tbar):
            ...
            #     data, labels = Batch_Augmentation2(data, labels, img_h=args.base_size, img_w=args.base_size)
